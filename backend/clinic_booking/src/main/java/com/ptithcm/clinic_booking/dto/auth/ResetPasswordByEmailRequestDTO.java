...
public class ResetPasswordByEmailRequestDTO {
    ...
    @Schema(description = "Token người dùng", example = "user@example.com", required = true)
    ...
    public ResetPasswordByEmailRequestDTO() {
    }

    public @NotBlank(message = "Token không được để trống") String getToken() {
        return token;
    }

    public void setToken(@NotBlank(message = "Token không được để trống") String token) {
        this.token = token;
    }
